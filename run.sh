...
export GOOGLE_APPLICATION_CREDENTIALS="/home/$USER/.gcloud/credentials.json"
echo "export GOOGLE_APPLICATION_CREDENTIALS=\"/home/$USER/.gcloud/credentials.json\"" >> ~/.bashrc
